...
export default function ExcelAI() {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex items-center gap-2 mb-6"><Table className="text-primary-400" size={22} /><h1 className="text-xl font-semibold">Excel AI</h1></div>
      <div className="flex gap-2 mb-4">
        ...
        <button className="btn-primary flex items-center gap-2" onClick={askAI} disabled={loading}><Sparkles size={16} /> {loading ? '...' : 'Ask AI'}</button>
      </div>
      ...
      <div className="flex gap-2 mt-4"><button className="btn-secondary flex items-center gap-2"><Upload size={16} /> Import</button><button className="btn-secondary flex items-center gap-2"><Download size={16} /> Export</button></div>
    </div>
  )
}
