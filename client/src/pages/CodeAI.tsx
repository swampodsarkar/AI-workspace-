...
export default function CodeAI() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center gap-2 mb-6"><Icons.Code className="text-primary-400" size={22} /><h1 className="text-xl font-semibold">Code AI</h1></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="card p-0 overflow-hidden">
          <div className="flex items-center justify-between px-4 py-2 border-b border-dark-700 bg-dark-800/50">
            ...
            <button className="p-1.5 rounded hover:bg-dark-700 text-dark-400 hover:text-white" onClick={copyCode}>{copied ? <Icons.Check size={14} /> : <Icons.Copy size={14} />}</button>
          </div>
        ...
        <div>
          <div className="card mb-4">
            <div className="flex items-center justify-between mb-3"><h3 className="font-semibold text-sm">Output</h3><button className="btn-primary text-xs py-1.5 px-3 flex items-center gap-1" onClick={runCode}><Icons.Play size={12} /> Run</button></div>
